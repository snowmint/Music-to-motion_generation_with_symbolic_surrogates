...
for this_performer in performaer_list:
    ...
    for item_path in audio_path_list:
        ...
        # Save as pickle
        if not os.path.exists('./preprocessed_data_save_cross_audio/audio/'):
            os.makedirs('./preprocessed_data_save_cross_audio/audio/')

        audio_data_output = open('./preprocessed_data_save_cross_audio/audio/' +
        ...
        if not os.path.exists('./preprocessed_data_save_cross_audio/motion/'):
            os.makedirs('./preprocessed_data_save_cross_audio/motion/')

        motion_data_output = open('./preprocessed_data_save_cross_audio/motion/' +
                                  name_code + '_motion_data.pkl', 'wb')
